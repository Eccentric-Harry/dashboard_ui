 ...
 *
 * The stroke is ink black in light mode: the tiles already carry the domain colors,
 * and a single neutral ring keeps the panel's one loud element loud. It is painted
 * through a gradient whose stops fall back to that ink, so dark mode can give the
 * ring a hue (theme-dark.css sets --loop-stop-a/b) without light mode changing.
 */
  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 200" aria-hidden="true">
        <defs>
          {/* Horizontal across the ring: the arc runs bottom-left, over the top, to
              bottom-right, so the colour travels with the sweep. */}
