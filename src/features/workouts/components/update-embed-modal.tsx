  ...
  return createPortal(
    ...
    <div className="workouts-modal-backdrop" onClick={requestClose}>
      <div className="workouts-modal-popover" style={{ maxWidth: '480px' }} onClick={e => e.stopPropagation()}>
        <button type="button" className="workouts-modal-close" onClick={requestClose}><X size={20} /></button>
        ...
        <form onSubmit={handleSubmit} className="workouts-form">
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
            <button type="button" className="workouts-btn-secondary" onClick={requestClose} style={{ flex: 1, height: '40px', borderRadius: '12px', border: '1px solid var(--inline-line, rgba(0,0,0,0.1))', background: 'transparent', fontWeight: 700, fontSize: '12px', cursor: 'pointer' }}>Cancel</button>
