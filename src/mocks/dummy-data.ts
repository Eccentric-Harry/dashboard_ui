  ...
  return [
    {
      ...
      goal: 'Walk through a large-scale design confidently in a 45-minute interview',
      isPrimary: true,
      status: 'ACTIVE',
      steps: [
        { id: 'ps-1-1', text: 'Complete Chapters 1-4 of DDIA', isCompleted: true, estimateMinutes: 120, spentMinutes: 140 },
        { id: 'ps-1-2', text: 'Design a URL Shortener (preparation)', isCompleted: true, estimateMinutes: 90, spentMinutes: 75 },
        {
          id: 'ps-1-3',
          text: 'Design WhatsApp/Chat System',
          isCompleted: false,
          children: [
            { id: 'ps-1-3-1', text: 'Sketch the message delivery flow', isCompleted: true, estimateMinutes: 30, spentMinutes: 35 },
            {
              id: 'ps-1-3-2',
              ...
              children: [
                {
                  id: 'ps-1-3-2-1',
                  text: 'Compare Cassandra and DynamoDB',
                  isCompleted: false,
                  estimateMinutes: 45,
                  spentMinutes: 20,
                  resumeNote: 'Read the DynamoDB partition docs; next: compare their write paths',
                },
                { id: 'ps-1-3-2-2', text: 'Estimate storage for 1B messages a day', isCompleted: false, estimateMinutes: 30 },
              ],
            },
            { id: 'ps-1-3-3', text: 'Handle presence and read receipts', isCompleted: false, estimateMinutes: 45 },
          ],
        },
        { id: 'ps-1-4', text: 'Design a Distributed Key-Value Store', isCompleted: false, estimateMinutes: 120 },
        { id: 'ps-1-5', text: 'Practice mock interviews with peers', isCompleted: false, estimateMinutes: 60 },
      ],
    },
    {
      id: 'p-2',
